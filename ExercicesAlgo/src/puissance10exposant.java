...
public class puissance10exposant {
    ...
    public static void main(String[] args) {
        ...
        L’utilisateur entre également l’exposent
        qu’il désire calculer*/

        long base;
        int compteur, entree, exposant;
        boolean envie = true;
        ...
        while(envie) {
            ...
            System.out.println("Veuillez entrer l'exposant E");
            exposant = recup.nextInt();
            ...
            System.out.println("Le resultat de N à la puissance de"+ exposant + " est : " + base);
